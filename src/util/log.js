;(function () {
  ...
  var C = {
    init: function () {
      ...
      wrapper.style.cssText = 'font-size:11px;line-height:1.1;word-break:break-all;position:absolute;position:fixed;bottom:0;right:0;background-color:#fff;width:90px;opacity:0.8;z-index:999999999';
